...
namespace task_2._0.Models
{
    public class Repository
    {
        ...
        public bool CheckUserExists(string userName, string mobileNo, string email)
        {
           
                SqlCommand cmd = new SqlCommand("spCheckUserExists", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        //}
        public List<Register> Details(string Email,string Password)
        {
            List<Register> obj = new List<Register>();
            
            SqlCommand cmd = new SqlCommand("pro_SELECT_STUDENT11", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmd = new SqlCommand("proc_Update_Student1A", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Id", r.Id);
            cmd.Parameters.AddWithValue("@Name", r.Name);
            cmd.Parameters.AddWithValue("@Password", r.Password);
        ...
        {
            SqlCommand cmd = new SqlCommand("proc_Delete_Admin1 ", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Id", id);
